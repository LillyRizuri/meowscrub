            ...
            if (!args) {
                ...
                const globalCasesEmbed = new Discord.MessageEmbed()
                    ...
                    .addFields({
                        ...
                        name: 'Deaths',
                        value: `${totalStats.deaths.toLocaleString()} (${((totalStats.deaths / totalStats.cases) * 100).toFixed(2)}%)`,
                        inline: true
                    }, {
                        name: 'Tests',
                ...
                const setCountryEmbed = new Discord.MessageEmbed()
                    ...
                    .addFields({
                        ...
                        name: 'Active',
                        value: `${country.active.toLocaleString()} (${((country.active / country.cases) * 100).toFixed(2)}%)`,
                        inline: true
                    }, {
                        name: 'Recovered',
                        value: `${country.recovered.toLocaleString()} (${((country.recovered / country.cases) * 100).toFixed(2)}%)`,
                        inline: true
                    }, {
                        name: 'Deaths',
                        value: `${country.deaths.toLocaleString()} (${((country.deaths / country.cases) * 100).toFixed(2)}%)`,
                        inline: true
                    }, {
                        name: 'Tests',
                    ...
                    .setThumbnail(`https://www.countryflags.io/${require('../../assets/json/countries_abbreviation.json')[country.country]}/flat/64.png`)
                    .setFooter(`Last Updated: ${updatedTime}`)
