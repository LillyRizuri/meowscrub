...
module.exports = class EditGiveawayCommand extends Commando.Command {
    ...
    async run(message, args) {
        ...
        if (!messageID || !giveawayDuration || !giveawayWinners || !giveawayPrize) {
        ...
        this.client.giveawaysManager.edit(messageID, {
            ...
            const confirmEmbed = new Discord.MessageEmbed()
                .setColor(green)
                .setDescription(`<:scrubgreen:797476323316465676> Edited all properties for this giveaway ID: \`${messageID}\`.`)
