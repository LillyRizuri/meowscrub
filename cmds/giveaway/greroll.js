        ...
        this.client.giveawaysManager.reroll(messageID)
            .then(() => {
                const confirmEmbed = new Discord.MessageEmbed()
                    .setColor(green)
                    .setDescription(`<:scrubgreen:797476323316465676> Rerolled a giveaway with this message ID: \`${messageID}\`.`)
                ...
                const errorEmbed = new Discord.MessageEmbed()
                    .setColor(red)
                    .setDescription(`<:scrubred:797476323169533963> There's no giveaway with this message ID: \`${messageID}\`.`)
