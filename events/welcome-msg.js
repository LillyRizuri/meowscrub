...
module.exports = (client) => {
    ...
    const welcomeMsgEmbed = new Discord.MessageEmbed()
        .setColor(embedcolor)
        .setTitle('Frockles the Bot (meowscrub)')
...
▫ **COVID-19 Stat**
I can also show some of the current COVID-19 stats in your desired place. From countries to provinces and US states. Thanks CoronaCord.
▫ **Encoding your Text**
...
▫ **Managing & Creating Giveaway**
One step closer into creating a simple giveaway entry, and modify it however you'd like.
▫ **Meh Moderation System**
It's not good but whatever. I only got to kick, ban, change a member's nickname, and sniping a latest deleted message.
▫ **Proud Music System**
...
`)
        .addFields({
            ...
            value: `You can have the link. [Have this.](https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=2083911167)`
        }, {
