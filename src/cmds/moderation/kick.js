  ...
  async run(message, args) {
    ...
    switch (target) {
      case message.author:
        const kickingYourselfEmbed = new Discord.MessageEmbed()
          .setColor(red)
          .setDescription(
            "<:scrubred:797476323169533963> Kicking yourself? Try leaving the server."
          )
      ...
      case this.client.user:
        const kickingItselfEmbed = new Discord.MessageEmbed()
          .setColor(red)
          .setDescription(
            "<:scrubred:797476323169533963> Kicking myself? Do I need to leave by myself?"
          )
          .setFooter("wot.")
          .setTimestamp();
    ...
    if (user.kickable) {
      ...
      const kickBruhEmbed = new Discord.MessageEmbed()
        .setColor(red)
        .setDescription(
          "<:scrubred:797476323169533963> How in the world can I kick the user you specified?"
        )
        .setFooter("ya bafoon")
        .setTimestamp();
